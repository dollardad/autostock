...
This plugin is still under development but the stable version is safe to use on a production site. Please contact me
directly for additional features ie "wish list".
...
= How long until new features are added =

I hope to be adding new features on a regular basis, most weeks
